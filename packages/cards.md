...
<!--<div class="article__asset">
  <a class="article__asset-link"
     href="http://mdcui.com/demo/card.html">
...
[Material Design card component](http://mdcui.com/material-design/components/cards.html), and makes it available to
...
<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/cards.html">Material Design guidelines: Cards</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/card.html">Demo</a>
  </li>
</ul>
