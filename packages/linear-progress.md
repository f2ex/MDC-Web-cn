...
<!--<div class="article__asset">
  <a class="article__asset-link"
      href="http://mdcui.com/demo/linear-progress.html">
...
[Material Design progress & activity requirements](http://mdcui.com/material-design/components/progress-activity.html).

## Design & API Documentation

<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/progress-activity.html">Guidelines</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/linear-progress.html">Demo</a>
  </li>
</ul>
