...
<!--<div class="article__asset">
  <a class="article__asset-link"
     href="http://mdcui.com/demo/toolbar/index.html">
...
<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/toolbars.html">Material Design guidelines: Toolbars</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/toolbar/index.html">Demo</a>
  </li>
</ul>
