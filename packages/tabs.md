...
[Material Design tabs guidelines](http://mdcui.com/material-design/components/tabs.html). These components are:
...
<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/tabs.html">Material Design guidelines: Tabs</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/tabs.html">Demo</a>
  </li>
</ul>
