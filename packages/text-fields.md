...
<!--<div class="article__asset">
  <a class="article__asset-link"
     href="http://mdcui.com/demo/textfield.html">
    <img src="{{ site.rootpath }}/images/mdc_web_screenshots/textfields.png" width="240" alt="Text fields screenshot">
  </a>
</div>-->

The MDC Text Field component provides a textual input field adhering to the [Material Design Specification](http://mdcui.com/material-design/components/text-fields.html).
...
<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/text-fields.html">Material Design guidelines: Text Fields</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/textfield.html">Demo</a>
  </li>
</ul>
