...
<!--<div class="article__asset">
  <a class="article__asset-link"
     href="http://mdcui.com/demo/simple-menu.html">
...
[Material Design menu specification](http://mdcui.com/material-design/components/menus.html).
...
<ul class="icon-list">
  ...
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/simple-menu.html">Demo</a>
  </li>
</ul>
