...
<!--<div class="article__asset">
  <a class="article__asset-link"
     href="http://mdcui.com/demo/dialog.html">
...
[Material Design dialog pattern](http://mdcui.com/material-design/components/dialogs.html).
...
<ul class="icon-list">
  <li class="icon-list-item icon-list-item--spec">
    <a href="http://mdcui.com/material-design/components/dialogs.html">Material Design guidelines: Dialogs</a>
  </li>
  <li class="icon-list-item icon-list-item--link">
    <a href="http://mdcui.com/demo/dialog.html">Demo</a>
  </li>
</ul>
